            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand">@yield('jumbotron')</a>
                    </div>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <div class="copyright float-right" id="date">
                        Copyright , made with <i class="material-icons">favorite</i> by
                        <a href="https://github.com/grimsalphadev" target="_blank">Heri Rahman</a>
                    </div>
                </div>
            </footer>
            <script>
